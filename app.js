...
// === МОДУЛЬ ЮРИДИЧЕСКИЙ ХАБ (ULTIMATE CORE) ===
const lawsDB = {
    ru: [
        "ГК РФ (Гражданский кодекс) — основа всех договорных отношений и интеллектуальной собственности.",
        "ТК РФ (Трудовой кодекс) — регулирует трудовые отношения. Важно: отличать трудовой договор от ГПХ.",
        "НК РФ (Налоговый кодекс) — правила уплаты налогов, сроки, штрафы (НПД, УСН, НДФЛ).",
        "152-ФЗ 'О персональных данных' — требования к сбору, хранению и обработке данных клиентов.",
        "44-ФЗ и 223-ФЗ — регулируют государственные и муниципальные закупки.",
        "Закон № 422-ФЗ 'О самозанятых' — специальный налоговый режим (НПД).",
        "Закон 'О защите прав потребителей' — применяется при работе с физическими лицами-заказчиками.",
        "КоАП РФ — административная ответственность (штрафы за нарушения, например, в рекламе или данных).",
        "УК РФ (ст. 159, 199) — уголовная ответственность за мошенничество и уклонение от уплаты налогов.",
        "149-ФЗ 'Об информации' — регулирование интернета, сайтов, блокировок и авторских прав в сети.",
        "Закон 'О валютном регулировании' (173-ФЗ) — правила работы с иностранными заказчиками.",
        "Постановление Пленума ВС РФ № 25 — разъяснения по интеллектуальным правам и договорам."
    ],
    by: [
        "Гражданский кодекс РБ — основа гражданско-правовых отношений в Беларуси.",
        "Трудовой кодекс РБ — регулирование трудовых отношений (отличие от договоров подряда).",
        "Налоговый кодекс РБ — правила налогообложения, включая режим НПД.",
        "Закон РБ 'О защите прав потребителей' — права заказчиков-физлиц.",
        "Закон РБ 'Об информации, информатизации и защите информации' — аналог 152-ФЗ.",
        "Декрет № 7 'О развитии предпринимательства' — льготы и поддержка ИП и самозанятых.",
        "Правила валютного регулирования РБ — контроль за контрактами в иностранной валюте.",
        "Закон РБ 'О рекламе' — требования к маркировке и содержанию рекламы.",
        "Кодекс РБ об административных правонарушениях (КоАП) — штрафы для фрилансеров.",
        "Указ № 395 — особенности работы с платежными агрегаторами и эквайрингом."
    ],
    cn: [
        "Гражданский кодекс КНР (Civil Code) — базовый закон о договорах, собственности и обязательствах.",
        "Закон КНР о трудовых договорах (Labor Contract Law) — строгое регулирование найма.",
        "Закон КНР о защите персональной информации (PIPL) — строгие правила хранения данных граждан КНР внутри страны.",
        "Закон КНР о кибербезопасности (Cybersecurity Law) — требования к IT-проектам и данным.",
        "Закон КНР об электронной коммерции (E-Commerce Law) — регулирование онлайн-продаж и услуг.",
        "Закон КНР о защите прав потребителей — права конечных потребителей.",
        "Правила валютного контроля SAFE — строгие правила получения и отправки иностранной валюты.",
        "Закон КНР о контрактах на научно-технические услуги — специфика IT-аутсорсинга.",
        "Регламенты о печатях (Chops) — юридическая сила круглой красной печати компании.",
        "Закон КНР об авторском праве (Copyright Law) — защита кода, дизайна и контента."
    ]
};

const legalDictionary = [
    "Акцепт|Полное и безоговорочное согласие принять условия оферты (договора).",
    "Алименты|Денежные средства, выплачиваемые на содержание несовершеннолетних или нетрудоспособных лиц.",
    "Апелляция|Обжалование решения суда, которое ещё не вступило в законную силу.",
    "Арбитраж|Суд, рассматривающий экономические споры между юридическими лицами и ИП.",
    "Аффидевит|Письменное показание, данное под присягой (часто используется в международном праве).",
    "Банкротство|Признанная судом неспособность должника полностью удовлетворить требования кредиторов.",
    "Виндикация|Истребование имущества владельцем из чужого незаконного владения.",
    "Гарантия|Обязательство отвечать за надлежащее исполнение обязательства третьим лицом.",
    "Гестор|Лицо, действующее в чужом интересе без прямого поручения (ведение чужих дел без поручения).",
    "Депозит|Денежные средства или ценные бумаги, внесенные в учреждение для хранения или обеспечения обязательств.",
    "Деликт|Гражданское правонарушение, влекущее обязанность возместить причиненный вред.",
    "Доверенность|Письменное уполномочие, выдаваемое одним лицом другому для представительства перед третьими лицами.",
    "Залог|Способ обеспечения исполнения обязательства, при котором кредитор имеет право получить удовлетворение из стоимости заложенного имущества.",
    "Иск|Требование о защите нарушенного или оспариваемого права, обращенное в суд.",
    "Истец|Лицо, обращающееся в суд за защитой своего права или законного интереса.",
    "Кассация|Обжалование вступивших в законную силу судебных решений.",
    "Контракт|Разновидность договора, часто используемая во внешнеэкономической деятельности.",
    "Конфискация|Принудительное безвозмездное изъятие имущества в собственность государства.",
    "Лизинг|Долгосрочная аренда имущества с возможностью последующего выкупа.",
    "Неустойка (штраф, пеня)|Денежная сумма, которую должник обязан уплатить кредитору в случае неисполнения обязательства.",
    "Оферта|Адресованное одному или нескольким лицам предложение, которое достаточно определенно и выражает намерение заключить договор.",
    "Патент|Исключительное право, удостоверяющее авторство и приоритет изобретения.",
    "Презумпция|Предположение, которое считается истинным, пока не доказано обратное (напр., презумпция невиновности).",
    "Претензия|Требование об устранении нарушений, направляемое до обращения в суд (досудебный порядок).",
    "Реквизиция|Принудительное изъятие имущества у собственника с выплатой компенсации.",
    "Реституция|Возврат сторон договора в первоначальное положение при его недействительности.",
    "Сервитут|Право ограниченного пользования чужим земельным участком или имуществом.",
    "Субсидиарная ответственность|Дополнительная ответственность лица, которое отвечает по долгам основного должника.",
    "Убытки|Расходы, которые лицо произвело или должно будет произвести для восстановления нарушенного права, плюс упущенная выгода.",
    "Уступка требования (Цессия)|Передача права требования от одного лица (цедента) к другому (цессионарию).",
    "Форс-мажор|Чрезвычайные и непредотвратимые обстоятельства, освобождающие от ответственности за неисполнение договора.",
    "Эмансипация|Объявление несовершеннолетнего, достигшего 16 лет, полностью дееспособным.",
    "Эскроу|Специальный банковский счет для безопасных расчетов между покупателем и продавцом.",
    "Юрисдикция|Право и полномочия государственного органа (суда) осуществлять правосудие и разрешать правовые споры.",
    "Агентский договор|Поручение агента совершать юридические и иные действия от имени принципала или от своего имени.",
    "Авторский надзор|Контроль автора проекта за соответствием строительных работ проектной документации.",
    "Аннулирование|Официальное признание документа или сделки недействительной.",
    "Бенефициар|Лицо, получающее выгоду от траста, банковского счета или страхового полиса.",
    "Встречное предоставление|Исполнение одной стороной договора своих обязательств в обмен на исполнение другой стороной.",
    "Дисконт|Скидка с цены товара или услуги, либо разница между номинальной стоимостью и ценой продажи.",
    "Задаток|Денежная сумма, выдаваемая одной из сторон в счет причитающихся платежей как доказательство заключения договора и обеспечение его исполнения.",
    "Индемнитет|Возмещение убытков или освобождение от ответственности, предусмотренное договором.",
    "Квалификационный аттестат|Документ, подтверждающий право специалиста на выполнение определенных видов работ.",
    "Ликвидация|Прекращение деятельности юридического лица без перехода его прав и обязанностей к другим лицам.",
    "Мораторий|Отсрочка, установленная законом или договором, на исполнение обязательств.",
    "Неосновательное обогащение|Приобретение или сбережение имущества за счет другого лица без установленных законом оснований.",
    "Оспаривание сделки|Признание судом недействительной сделки, совершенной с нарушением закона.",
    "Публичный договор|Договор, заключенный коммерческой организацией, устанавливающий ее обязанности по продаже товаров или услуг каждому, кто обратится.",
    "Роялти|Периодические платежи за право использования интеллектуальной собственности или франшизы.",
    "Солидарная ответственность|Обязанность нескольких должников ответить перед кредитором в полном объеме, при этом кредитор может требовать исполнения как от всех, так и от любого из них."
];
...
function renderLawHub() {
    ...
    h += '<div class="card" style="background:linear-gradient(135deg,#1a2035,#2a1040);border-color:#ffd700;margin-bottom:15px">';
    h += '<h3 style="margin-top:0">💡 Важно</h3>';
    h += '<div class="mut" style="font-size:13px">Приложение предоставляет справочную информацию (Ultimate Freelancer Core). Для сложных международных сделок рекомендуется консультация с профильным юристом.</div>';
    h += '</div>';
    ...
    for (const [key, data] of Object.entries(lawsDB)) {
        h += '<div class="law-item card" style="border-left:4px solid #6c8cff" data-search="' + key + ' ' + data.join(' ') + '">';
        h += '<h4 style="margin-top:0;margin-bottom:10px">' + (key === 'ru' ? '🇷🇺 Россия' : key === 'by' ? '🇧🇾 Беларусь' : '🇨🇳 Китай') + '</h4>';
        h += '<ul style="padding-left:20px;margin:0;color:#e8ecf3;font-size:13px;line-height:1.5">';
        data.forEach(law => {
    ...
    // Словарь терминов (первые 15 для превью, остальные по поиску)
    h += '<h3>📖 Юридический словарь (Ultimate Core)</h3>';
    h += '<div id="dictContainer" style="display:flex;flex-direction:column;gap:8px;margin-bottom:20px">';
    legalDictionary.slice(0, 15).forEach(item => {
        const [term, def] = item.split('|');
        h += '<div class="dict-item card" style="padding:12px" data-search="' + term.toLowerCase() + ' ' + def.toLowerCase() + '">';
        h += '<b style="font-size:14px;color:#6c8cff">' + term + '</b>';
        h += '<div style="font-size:12px;color:#e8ecf3;margin-top:4px">' + def + '</div>';
        h += '</div>';
    });
    h += '<div id="moreDictMsg" class="mut" style="text-align:center;padding:10px">Используй поиск выше, чтобы найти любой из 50+ терминов</div>';
    h += '</div>';
...
function filterLawHub() {
    ...
    moreMsg.style.display = dictVisibleCount === 0 ? 'block' : 'none';
    if (dictVisibleCount === 0 && query !== '') {
        moreMsg.textContent = 'Ничего не найдено. Попробуйте другой запрос.';
    } else {
